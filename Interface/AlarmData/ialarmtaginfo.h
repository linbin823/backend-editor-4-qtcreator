...
public:
    ...
    static QString enumStateString(int alaState){
        switch (alaState) {
        case STATE_DISABLE: return tr("禁用.");
        case STATE_INHIBIT: return tr("抑制.");
        case STATE_NORMAL: return tr("无报警.");
        case STATE_DELAYING: return tr("触发延时中.");
        case STATE_ALARM: return tr("报警触发.");

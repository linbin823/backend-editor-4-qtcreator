...
private:
    ...
    QList<ModbusMasterProtocolDriver::enumDataType> _supportedType;
    /*!
    ...
    QMap<ModbusMasterProtocolDriver::enumDataType, QMap<iTagInfo::enumRWStrategyCode,QList<TagAddress*> > > _tagAddresses;
    QMap<ModbusMasterProtocolDriver::enumDataType, QMap<iTagInfo::enumRWStrategyCode, QList<ModbusDataUnit> > > _dataUnits;
